...
import { QCResponse, PreviewableFile, ProcessedFileDataForDisplay, QCResult, QCStatus } from '@/shared/types';
import { FileTextIcon, Folder as FolderIcon, Inbox, CheckCircle } from 'lucide-react';
